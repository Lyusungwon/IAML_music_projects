...
class ROLLOUT(object):
    def __init__(self, lstm, update_rate):
        ...
        self.abc2midi_path = 'abc2midi/bin/abc2midi'
    ...
    def abc_to_midi(self, abc_filename):
        cmd = [self.abc2midi_path, abc_filename]
        print(self.abc2midi_path)
        print(abc_filename)
        process = subprocess.Popen(cmd, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE,
                                   creationflags=0, bufsize=-1)
